...
export const ConfidenceIndicator: React.FC<ConfidenceIndicatorProps> = ({
  ...
  const getConfidenceLabel = (conf: number): string => {
    ...
    if (conf >= 0.7) return t('goodConfidence');
    if (conf >= 0.4) return t('mediumConfidence');
  ...
  return (
    <div
      ...
      title={t('confidenceTitle', { percent: confidencePercent, label })}
      aria-label={t('transcriptionConfidenceAria', { percent: confidencePercent })}
    >
      <div
